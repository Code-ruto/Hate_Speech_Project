The Hate_Speech_Project is the beginning of a bigger project that would use this model in the future as a template to create a more robust machine learning model. 
